...
//go:embed "graphql/input.graphqls" "graphql/mutation.graphqls" "graphql/query.graphqls" "graphql/todo.graphqls" "graphql/user.graphqls"
...
var sources = []*ast.Source{
	...
	{Name: "graphql/todo.graphqls", Input: sourceData("graphql/todo.graphqls"), BuiltIn: false},
...
func (ec *executionContext) _Query_user(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.User)
	fc.Result = res
	return ec.marshalOUser2ᚖgithubᚗcomᚋ39TOᚋgockerqlᚋgraphᚋmodelᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOUser2ᚖgithubᚗcomᚋ39TOᚋgockerqlᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._User(ctx, sel, v)
